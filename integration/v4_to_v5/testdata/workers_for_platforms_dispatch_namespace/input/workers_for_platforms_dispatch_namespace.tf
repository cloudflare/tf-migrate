...
resource "cloudflare_workers_for_platforms_namespace" "deprecated_basic" {
  account_id = var.cloudflare_account_id
...
resource "cloudflare_workers_for_platforms_namespace" "deprecated_for_each" {
...
resource "cloudflare_workers_for_platforms_namespace" "deprecated_count" {
  count      = 3
  account_id = var.cloudflare_account_id
...
resource "cloudflare_workers_for_platforms_namespace" "deprecated_lifecycle" {
  account_id = var.cloudflare_account_id
