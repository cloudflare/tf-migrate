...
resource "cloudflare_managed_headers" "both_headers" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "multiple_headers" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "conditional_headers" {
...
resource "cloudflare_managed_headers" "env_specific" {
  for_each = var.header_configs

  zone_id = var.cloudflare_zone_id

  # Note: In v4, we can't dynamically create blocks from variables
  # This tests that static blocks work with for_each
  managed_request_headers {
...
resource "cloudflare_managed_headers" "with_locals" {
...
resource "cloudflare_managed_headers" "multi_zone" {
...
resource "cloudflare_managed_headers" "all_enabled" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "all_disabled" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "mixed_states" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "underscores" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "dashes" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "with_lifecycle" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "prevent_destroy" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "with_comments" {
  zone_id = var.cloudflare_zone_id  # Primary zone

  # Enable client IP headers for security
  managed_request_headers {
    id      = "add_true_client_ip_headers"
...
resource "cloudflare_managed_headers" "with_count" {
...
resource "cloudflare_managed_headers" "interpolated" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "ternary" {
  zone_id = var.cloudflare_zone_id
...
resource "cloudflare_managed_headers" "from_list" {
