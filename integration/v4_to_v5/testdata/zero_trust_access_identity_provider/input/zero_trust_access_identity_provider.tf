...
resource "cloudflare_access_identity_provider" "google_map" {
...
resource "cloudflare_access_identity_provider" "github_set" {
...
resource "cloudflare_access_identity_provider" "github_enterprise" {
  count = 3
...
resource "cloudflare_access_identity_provider" "conditional" {
