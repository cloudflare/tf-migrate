...
resource "cloudflare_access_mutual_tls_certificate" "e2e_basic" {
...
resource "cloudflare_access_mutual_tls_certificate" "e2e_zone" {
...
resource "cloudflare_access_mutual_tls_certificate" "e2e_foreach" {
  for_each = {
    env1 = local.cert3
  }
