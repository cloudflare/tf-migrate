...
resource "cloudflare_access_mutual_tls_certificate" "basic_account" {
...
resource "cloudflare_access_mutual_tls_certificate" "basic_zone" {
...
resource "cloudflare_access_mutual_tls_certificate" "minimal" {
  account_id  = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "empty_hostnames" {
  account_id           = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "single_hostname" {
  account_id           = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "environments" {
...
resource "cloudflare_access_mutual_tls_certificate" "apps" {
...
resource "cloudflare_access_mutual_tls_certificate" "regions" {
  for_each = {
    us-east = "us-east-1"
    us-west = "us-west-2"
    eu      = "eu-central-1"
...
resource "cloudflare_access_mutual_tls_certificate" "counted" {
  count = 3
...
resource "cloudflare_access_mutual_tls_certificate" "conditional" {
...
resource "cloudflare_access_mutual_tls_certificate" "variable_ref" {
  account_id           = var.cloudflare_account_id
...
# Using join() function
resource "cloudflare_access_mutual_tls_certificate" "with_join" {
  account_id  = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "with_format" {
  account_id           = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "app_cert" {
  account_id           = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "long_name" {
  account_id  = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "special_chars" {
  account_id           = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "zone_scoped" {
  zone_id              = var.cloudflare_zone_id
...
resource "cloudflare_access_mutual_tls_certificate" "with_lifecycle" {
  account_id  = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "ignore_changes" {
  account_id           = var.cloudflare_account_id
...
resource "cloudflare_access_mutual_tls_certificate" "dependent" {
  account_id           = var.cloudflare_account_id
  ...
  depends_on = [
    cloudflare_access_mutual_tls_certificate.basic_account
  ]
}
