...
resource "cloudflare_zero_trust_device_profiles" "custom_contractors" {
  account_id           = var.cloudflare_account_id
...
resource "cloudflare_zero_trust_device_profiles" "custom_admins" {
  account_id            = var.cloudflare_account_id
  name                  = "Admin Profile"
...
resource "cloudflare_zero_trust_device_profiles" "custom_teams" {
  for_each = {
    "engineering" = {
      precedence = 150
