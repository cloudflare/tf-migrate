...
func (m *V4ToV5Migrator) Preprocess(content string) string {
	// Rename resource type from cloudflare_access_policy to cloudflare_zero_trust_access_policy
...
func (m *V4ToV5Migrator) TransformConfig(ctx *transform.Context, block *hclwrite.Block) (*transform.TransformResult, error) {
	...
	// Config transformation is extremely complex (similar to access_group)
...
func (m *V4ToV5Migrator) TransformState(ctx *transform.Context, stateJSON gjson.Result, resourcePath string) (string, error) {
	...
	// Transform include, exclude, and require arrays (same as access_group)
...
// transformRuleArray transforms an array of rule objects (same logic as access_group)
