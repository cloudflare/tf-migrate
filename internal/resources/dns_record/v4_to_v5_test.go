...
// State transformation tests removed - state migration is now handled by the provider's
// StateUpgraders (MoveState/UpgradeState). The moved blocks generated by TransformConfig
// trigger the provider's migration logic.
