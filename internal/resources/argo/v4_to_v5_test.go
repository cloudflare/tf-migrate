...
`,
	...
	t.Run("StateTransformation", func(t *testing.T) {
		tests := []testhelpers.StateTestCase{
			...
			{
				Name: "Both attributes - transforms to smart_routing",
				Input: `{
					"schema_version": 0,
					"attributes": {
						"id": "checksum123",
			...
			{
				Name: "Neither attribute - defaults to off",
				Input: `{
					"schema_version": 0,
					"attributes": {
						"id": "checksum123",
			...
			{
				Name: "Smart routing off explicitly",
				Input: `{
					"schema_version": 0,
					"attributes": {
						"id": "checksum123",
			...
			{
				Name: "Tiered caching off explicitly",
				Input: `{
					"schema_version": 0,
					"attributes": {
						"id": "checksum456",
			...
			{
				Name: "State with type field - smart_routing",
				Input: `{
					"schema_version": 0,
					"attributes": {
						"id": "checksum123",
			...
			{
				Name: "State with type field - tiered_caching",
				Input: `{
					"schema_version": 0,
					"attributes": {
						"id": "checksum789",
			...
			{
				Name: "State without attributes block",
				Input: `{
					"schema_version": 0
				}`,
				Expected: `{
